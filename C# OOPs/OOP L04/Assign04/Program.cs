...
namespace Assign04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The Sum of 12 + 32 = {C.AddNumbers(12, 32)}");
            Console.WriteLine($"The Sum of 1 + 43 , 5 = {C.AddNumbers(1, 43, 5)}");
